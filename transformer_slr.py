...
class HandExtractor(nn.Module):
    def __init__(self, n_units=1280, pretrained=True, network_type='mb2'):
...
def make_model(tgt_vocab, n_stacks=3, n_units=512, n_heads=2, d_ff=2048, dropout=0.3, image_size=224, pretrained=True, emb_type='2d', emb_network='mb2'):
    ...
    model = FullTransformer(
        ...
        src_2Dembeddings(n_units, pretrained, image_size, network_type=emb_network),
